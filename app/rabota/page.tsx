 ...
 *
 * У каждого элемента подписано, какую работу он делает. Витрина без этого
 * превращается в набор красивых кусочков, из которого каждый берёт что хочет.
 */
  ...
  return (
    <div className="work min-h-screen">
      <div className="mx-auto max-w-4xl px-5 py-12 sm:px-8">
        ...
        <Block
          name="Кнопки"
          job="Сплошной фирменный оранжевый — язык действия, и только его. Тёмная кнопка — второе по важности действие внутри блока. Тихая — отмена и всё, о чём не жалко забыть."
        >
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              className="flex h-9 items-center gap-1.5 rounded-full px-4 text-xs font-bold"
        ...
        <Block
          name="Меню"
          job="Меню не спорит с действием. Текущий пункт обозначают три тихих средства сразу: нейтральная подложка, вес буквы 800 против 500 и фирменный цвет у одной пиктограммы. Подпись остаётся чёрной — цветной текст рядом с цветной кнопкой снова даёт два пятна."
        >
        ...
        <Block
          name="Плитка-строка"
          job="Главный элемент списков. Скругление крупное, но не капсула: капсула съедает соседство блоков, и список рассыпается на отдельные пилюли."
        >
          <div className="space-y-2">
            <div className="work-tile flex flex-wrap items-center gap-3 p-4">
              <span className="work-dot" data-tone="flame" />
              <div className="min-w-0 flex-1">
                <div className="font-semibold">Мария Ковалёва</div>
                <div className="text-xs" style={{ color: "var(--ink-soft)" }}>
                  тренер — Айрат Мухамедьяров · 3 ч
                </div>
              </div>
        ...
        <Block
          name="Чипы"
          job="Короткий признак у строки: срок, этап, беда, отметка. Высота одна у всех — разнокалиберные ярлыки в строке выглядят сбоем вёрстки. У нейтрального обводка обязательна: он чаще всего лежит на плитке того же тона и без неё пропадает."
        >
          <div className="flex flex-wrap gap-2">
            <span className="work-chip">3 из 5</span>
            <span className="work-chip" data-tone="lime">
        ...
        >
          <div className="space-y-5">
            <Bar title="Смета цела" spent={30} planned={0} over={0} note="провели 12 ч · осталось 28 ч из 40 ч" />
        ...
        <Block
          name="Человек"
          job="Инициалы кругом вместо фотографии: в рабочих экранах лицо не помогает, а подпись под именем говорит роль. Строка нажимается — значок справа об этом сообщает."
        >
          <div
...
function Block({
  ...
  return (
    <section className="mt-14">
      <h2 className="work-title text-xl">{name}</h2>
